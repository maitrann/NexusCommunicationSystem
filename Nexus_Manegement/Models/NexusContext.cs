...
namespace Nexus_Manegement.Models
{
    public class NexusContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-BBVNKGM;Initial Catalog=Nexus;Persist Security Info=True;User ID=sa;Password=123;TrustServerCertificate=True");
        }
